...
// function storeTaskInLocalStorage(name, task, date, status) {
//   let tasks = getTasksFromLocalStorage();
...
// function removeFromLocalStorage(name, status) {
//   let tasks = getTasksFromLocalStorage();
//   tasks = tasks.filter((task) => task.name !== name || task.status !== status);
//   localStorage.setItem("tasks", JSON.stringify(tasks));
// }
